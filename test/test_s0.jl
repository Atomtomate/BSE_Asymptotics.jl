...
for ωi in 1:size(χDMFTsp_impr_s0,3)
    improve_χ!(:sp, ωi, view(χDMFTsp_impr_s0,:,:,ωi), view(χ₀_s0,:,ωi), U_s0, β_s0, shift_s0, helper_s0);
    improve_χ!(:ch, ωi, view(χDMFTch_impr_s0,:,:,ωi), view(χ₀_s0,:,ωi), U_s0, β_s0, shift_s0, helper_s0);
end
...
for ωi in 1:size(χDMFTsp_impr_s1,3)
    improve_χ!(:sp, ωi, view(χDMFTsp_impr_s1,:,:,ωi), view(χ₀_s1,:,ωi), U_s1, β_s1, shift_s1, helper_s1);
    improve_χ!(:ch, ωi, view(χDMFTch_impr_s1,:,:,ωi), view(χ₀_s1,:,ωi), U_s1, β_s1, shift_s1, helper_s1);
end
;;
